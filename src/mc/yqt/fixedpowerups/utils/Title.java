...
public class Title {
	...
	public Title sendTitlePacket(Player p) {
		return this.sendTitlePacket(new LinkedList<Player>(Arrays.asList(p)));
	}
	...
	public Title sendSubtitlePacket(Player p) {
		return this.sendSubtitlePacket(new LinkedList<Player>(Arrays.asList(p)));
	}
	...
	public Title sendTimesPacket(Player p) {
		return this.sendTimesPacket(new LinkedList<Player>(Arrays.asList(p)));
	}
	...
	public void sendTitleClearPacket(Player p) {
		this.sendTitleClearPacket(new LinkedList<Player>(Arrays.asList(p)));
	}
	 ...
	 * @param Fade in time
	 * @param Fade out time
	 * @param Specific player that the packets are getting sent to
	 */
	public static void createTitle(String title, String subtitle, int time, int fadeIn, int fadeOut, Player p) {
		createTitle(title, subtitle, time, fadeIn, fadeOut, new LinkedList<Player>(Arrays.asList(p)));
	}
	 ...
	 * @param Fade in time
	 * @param Fade out time
	 * @param Collection of players that the packets are getting sent to
	 */
